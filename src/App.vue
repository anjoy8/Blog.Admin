                    ...
                    <aside :class="collapsedClass">
                        <el-scrollbar style="height:100%;background: #2f3e52;" class="scrollbar-handle">
                            <el-menu :default-active="$route.path" class="el-menu-vertical-demo" @open="handleopen"
                                ...
                                background-color="#2f3e52" style="border-right: none;" text-color="#fff"
...
export default {
        ...
        getUserInfoByToken(token) {
            ...
            getUserByToken(loginParams).then(data => {
                ...
                if (!data.success) {
                    ...
                    _this.sysUserName = data.response.Position ? `${data.response.uRealName}（${data.response.Position}）` : data.response.uRealName;
    ...
    updated() {
        ...
        if (user) {
            let sysUserNameAll = user.Position ? `${user.uRealName}（${user.Position}）` : user.uRealName;
            this.sysUserName = sysUserNameAll || '老张的哲学';
